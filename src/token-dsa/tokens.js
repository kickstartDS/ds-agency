 ...
 * Generated on Thu, 16 Nov 2023 08:45:31 GMT
 */
...
export const KsBackgroundColorDefaultInvertedBase = "#cdc0f4";
...
export const KsBackgroundColorInterfaceInteractiveHoverBase = "rgba(255, 255, 255, 0.05)";
export const KsBackgroundColorInterfaceInteractiveActiveBase = "rgba(255, 255, 255, 0.05)";
export const KsBackgroundColorInterfaceInteractiveSelectedBase = "#5435d2";
...
export const KsBackgroundColorInterfaceInvertedInteractiveHoverBase = "rgba(6, 8, 31, 0.05)";
export const KsBackgroundColorInterfaceInvertedInteractiveActiveBase = "rgba(6, 8, 31, 0.05)";
export const KsBackgroundColorInterfaceInvertedInteractiveSelectedBase = "#e21879";
...
export const KsBackgroundColorPrimaryInteractiveActiveBase = "#412aa7";
export const KsBackgroundColorPrimaryInteractiveSelectedBase = "#5435d2";
export const KsBackgroundColorPrimaryTranslucentBase = "rgba(84, 53, 210, 0.13)";
export const KsBackgroundColorPrimaryInvertedBase = "#e21879";
export const KsBackgroundColorPrimaryInvertedInteractiveBase = "#e21879";
export const KsBackgroundColorPrimaryInvertedInteractiveHoverBase = "#2d1f79";
export const KsBackgroundColorPrimaryInvertedInteractiveActiveBase = "#e94f99";
export const KsBackgroundColorPrimaryInvertedInteractiveSelectedBase = "#e21879";
export const KsBackgroundColorPrimaryInvertedTranslucentBase = "rgba(226, 24, 121, 0.13)";
export const KsBackgroundColorBoldBase = "#231961";
export const KsBackgroundColorBoldInvertedBase = "rgba(84, 53, 210, 0.24)";
export const KsBorderColorAccentBase = "rgba(255, 255, 255, 0.13)";
export const KsBorderColorAccentInvertedBase = "rgba(6, 8, 31, 0.13)";
export const KsBorderColorClearBase = "rgba(0, 0, 0, 0)";
export const KsBorderColorClearInteractiveBase = "rgba(0, 0, 0, 0)";
export const KsBorderColorClearInteractiveHoverBase = "rgba(84, 53, 210, 0.13)";
export const KsBorderColorClearInteractiveActiveBase = "rgba(84, 53, 210, 0.24)";
export const KsBorderColorClearInteractiveSelectedBase = "rgba(84, 53, 210, 0.37)";
...
export const KsBorderColorClearInvertedInteractiveHoverBase = "rgba(226, 24, 121, 0.24)";
export const KsBorderColorClearInvertedInteractiveActiveBase = "rgba(226, 24, 121, 0.37)";
export const KsBorderColorClearInvertedInteractiveSelectedBase = "rgba(226, 24, 121, 0.5)";
export const KsBorderColorDefaultBase = "#06081f";
export const KsBorderColorDefaultInvertedBase = "rgba(255, 255, 255, 0.76)";
export const KsBorderColorInterfaceBase = "rgba(255, 255, 255, 0.05)";
...
export const KsBorderColorInterfaceInteractiveActiveBase = "rgba(255, 255, 255, 0.76)";
export const KsBorderColorInterfaceInteractiveSelectedBase = "#5435d2";
export const KsBorderColorInterfaceInvertedBase = "rgba(6, 8, 31, 0.05)";
export const KsBorderColorInterfaceInvertedInteractiveBase = "rgba(6, 8, 31, 0.5)";
export const KsBorderColorInterfaceInvertedInteractiveDisabledBase = "rgba(6, 8, 31, 0.87)";
export const KsBorderColorInterfaceInvertedInteractiveHoverBase = "rgba(6, 8, 31, 0.76)";
export const KsBorderColorInterfaceInvertedInteractiveActiveBase = "rgba(6, 8, 31, 0.95)";
export const KsBorderColorInterfaceInvertedInteractiveSelectedBase = "#e21879";
export const KsBorderColorPrimaryBase = "#5435d2";
export const KsBorderColorPrimaryInteractiveBase = "#5435d2";
export const KsBorderColorPrimaryInteractiveHoverBase = "#4a2fbb";
export const KsBorderColorPrimaryInteractiveActiveBase = "#412aa7";
export const KsBorderColorPrimaryInteractiveSelectedBase = "#5435d2";
export const KsBorderColorPrimaryTranslucentBase = "rgba(84, 53, 210, 0.87)";
export const KsBorderColorPrimaryInvertedBase = "#e21879";
export const KsBorderColorPrimaryInvertedInteractiveBase = "#e21879";
export const KsBorderColorPrimaryInvertedInteractiveHoverBase = "#e6368a";
export const KsBorderColorPrimaryInvertedInteractiveActiveBase = "#e94f99";
export const KsBorderColorPrimaryInvertedInteractiveSelectedBase = "#e21879";
export const KsBorderColorPrimaryInvertedTranslucentBase = "rgba(226, 24, 121, 0.87)";
export const KsBorderWidthDefault = "2px";
export const KsBorderWidthEmphasized = "4px";
export const KsBorderRadiusControl = "2px";
export const KsBorderRadiusCard = "16px";
export const KsBorderRadiusSurface = "20px";
...
export const KsBoxShadowColorControl = "rgba(201,203,227,0.2)";
export const KsBoxShadowColorControlHover = "rgba(201,203,227,0.3)";
export const KsBoxShadowColorCard = "rgba(201,203,227,0.2)";
export const KsBoxShadowColorCardHover = "rgba(201,203,227,0.3)";
export const KsBoxShadowColorSurface = "rgba(201,203,227,0.1)";
export const KsBoxShadowColorSurfaceHover = "rgba(201,203,227,0.2)";
export const KsBoxShadowControl = "0 1px 2.75px rgba(201,203,227,0.2)";
export const KsBoxShadowControlHover = "0 1px 5.5px rgba(201,203,227,0.3)";
export const KsBoxShadowCard = "0 1px 5.5px rgba(201,203,227,0.2)";
export const KsBoxShadowCardHover = "0 1px 11px rgba(201,203,227,0.3)";
export const KsBoxShadowSurface = "0 1px 11px rgba(201,203,227,0.1)";
export const KsBoxShadowSurfaceHover = "0 1px 22px rgba(201,203,227,0.2)";
...
export const KsColorFgInvertedToBg2Base = "#26283c";
export const KsColorFgInvertedToBg3Base = "#424355";
export const KsColorFgInvertedToBg4Base = "#626372";
export const KsColorFgInvertedToBg5Base = "#83848f";
export const KsColorFgInvertedToBg6Base = "#a3a4ac";
export const KsColorFgInvertedToBg7Base = "#c3c4c9";
export const KsColorFgInvertedToBg8Base = "#dfdfe2";
export const KsColorFgInvertedToBg9Base = "#f3f3f4";
...
export const KsColorPositiveInvertedToBg1Base = "#2e8926";
export const KsColorPositiveInvertedToBg2Base = "#409339";
export const KsColorPositiveInvertedToBg3Base = "#58a152";
export const KsColorPositiveInvertedToBg4Base = "#74b16f";
export const KsColorPositiveInvertedToBg5Base = "#91c18d";
export const KsColorPositiveInvertedToBg6Base = "#aed1ab";
export const KsColorPositiveInvertedToBg7Base = "#cae1c8";
export const KsColorPositiveInvertedToBg8Base = "#e2efe1";
export const KsColorPositiveInvertedToBg9Base = "#f4f9f4";
...
export const KsColorInformativeInvertedToBg1Base = "#0d7895";
export const KsColorInformativeInvertedToBg2Base = "#21839e";
export const KsColorInformativeInvertedToBg3Base = "#3d93aa";
export const KsColorInformativeInvertedToBg4Base = "#5ea6b8";
export const KsColorInformativeInvertedToBg5Base = "#80b8c7";
export const KsColorInformativeInvertedToBg6Base = "#a1cad6";
export const KsColorInformativeInvertedToBg7Base = "#c2dde4";
export const KsColorInformativeInvertedToBg8Base = "#deedf0";
export const KsColorInformativeInvertedToBg9Base = "#f2f8f9";
...
export const KsColorNoticeInvertedToBg1Base = "#ff655c";
export const KsColorNoticeInvertedToBg2Base = "#ff7269";
export const KsColorNoticeInvertedToBg3Base = "#ff847c";
export const KsColorNoticeInvertedToBg4Base = "#ff9993";
export const KsColorNoticeInvertedToBg5Base = "#ffaea9";
export const KsColorNoticeInvertedToBg6Base = "#ffc3bf";
export const KsColorNoticeInvertedToBg7Base = "#ffd8d6";
export const KsColorNoticeInvertedToBg8Base = "#ffeae9";
export const KsColorNoticeInvertedToBg9Base = "#fff7f6";
...
export const KsColorNegativeInvertedToBg2Base = "#d83a60";
export const KsColorNegativeInvertedToBg3Base = "#dd5374";
export const KsColorNegativeInvertedToBg4Base = "#e3718c";
export const KsColorNegativeInvertedToBg5Base = "#e98ea4";
export const KsColorNegativeInvertedToBg6Base = "#eeabbb";
export const KsColorNegativeInvertedToBg7Base = "#f4c9d3";
export const KsColorNegativeInvertedToBg8Base = "#f9e2e7";
export const KsColorNegativeInvertedToBg9Base = "#fdf4f6";
export const KsColorSecondaryBase = "#e21879";
export const KsColorSecondaryAlpha1Base = "rgba(226, 24, 121, 0.95)";
export const KsColorSecondaryAlpha2Base = "rgba(226, 24, 121, 0.87)";
export const KsColorSecondaryAlpha3Base = "rgba(226, 24, 121, 0.76)";
export const KsColorSecondaryAlpha4Base = "rgba(226, 24, 121, 0.63)";
export const KsColorSecondaryAlpha5Base = "rgba(226, 24, 121, 0.5)";
export const KsColorSecondaryAlpha6Base = "rgba(226, 24, 121, 0.37)";
export const KsColorSecondaryAlpha7Base = "rgba(226, 24, 121, 0.24)";
export const KsColorSecondaryAlpha8Base = "rgba(226, 24, 121, 0.13)";
export const KsColorSecondaryAlpha9Base = "rgba(226, 24, 121, 0.05)";
export const KsColorSecondaryToBg1Base = "#d71775";
export const KsColorSecondaryToBg2Base = "#c5166d";
export const KsColorSecondaryToBg3Base = "#ad1463";
export const KsColorSecondaryToBg4Base = "#911258";
export const KsColorSecondaryToBg5Base = "#74104c";
export const KsColorSecondaryToBg6Base = "#570e40";
export const KsColorSecondaryToBg7Base = "#3b0c35";
export const KsColorSecondaryToBg8Base = "#230a2b";
export const KsColorSecondaryToBg9Base = "#110924";
export const KsColorSecondaryInvertedBase = "#5435d2";
export const KsColorSecondaryInvertedAlpha1Base = "rgba(84, 53, 210, 0.95)";
export const KsColorSecondaryInvertedAlpha2Base = "rgba(84, 53, 210, 0.87)";
export const KsColorSecondaryInvertedAlpha3Base = "rgba(84, 53, 210, 0.76)";
export const KsColorSecondaryInvertedAlpha4Base = "rgba(84, 53, 210, 0.63)";
export const KsColorSecondaryInvertedAlpha5Base = "rgba(84, 53, 210, 0.5)";
export const KsColorSecondaryInvertedAlpha6Base = "rgba(84, 53, 210, 0.37)";
export const KsColorSecondaryInvertedAlpha7Base = "rgba(84, 53, 210, 0.24)";
export const KsColorSecondaryInvertedAlpha8Base = "rgba(84, 53, 210, 0.13)";
export const KsColorSecondaryInvertedAlpha9Base = "rgba(84, 53, 210, 0.05)";
export const KsColorSecondaryInvertedToBg1Base = "#5d3fd4";
export const KsColorSecondaryInvertedToBg2Base = "#6a4fd8";
export const KsColorSecondaryInvertedToBg3Base = "#7d65dd";
export const KsColorSecondaryInvertedToBg4Base = "#9380e3";
export const KsColorSecondaryInvertedToBg5Base = "#aa9ae9";
export const KsColorSecondaryInvertedToBg6Base = "#c0b4ee";
export const KsColorSecondaryInvertedToBg7Base = "#d6cff4";
export const KsColorSecondaryInvertedToBg8Base = "#e9e5f9";
export const KsColorSecondaryInvertedToBg9Base = "#f6f5fd";
...
export const KsColorBgToBg1Base = "#06081f";
export const KsColorBgToBg2Base = "#06081f";
export const KsColorBgToBg3Base = "#06081f";
export const KsColorBgToBg4Base = "#06081f";
export const KsColorBgToBg5Base = "#06081f";
export const KsColorBgToBg6Base = "#06081f";
export const KsColorBgToBg7Base = "#06081f";
export const KsColorBgToBg8Base = "#06081f";
export const KsColorBgToBg9Base = "#06081f";
export const KsColorBgInvertedBase = "#cdc0f4";
export const KsColorBgInvertedAlpha1Base = "rgba(205, 192, 244, 0.95)";
export const KsColorBgInvertedAlpha2Base = "rgba(205, 192, 244, 0.87)";
export const KsColorBgInvertedAlpha3Base = "rgba(205, 192, 244, 0.76)";
export const KsColorBgInvertedAlpha4Base = "rgba(205, 192, 244, 0.63)";
export const KsColorBgInvertedAlpha5Base = "rgba(205, 192, 244, 0.5)";
export const KsColorBgInvertedAlpha6Base = "rgba(205, 192, 244, 0.37)";
export const KsColorBgInvertedAlpha7Base = "rgba(205, 192, 244, 0.24)";
export const KsColorBgInvertedAlpha8Base = "rgba(205, 192, 244, 0.13)";
export const KsColorBgInvertedAlpha9Base = "rgba(205, 192, 244, 0.05)";
export const KsColorBgInvertedToBg1Base = "#d0c3f5";
export const KsColorBgInvertedToBg2Base = "#d4c8f5";
export const KsColorBgInvertedToBg3Base = "#d9cff7";
export const KsColorBgInvertedToBg4Base = "#e0d7f8";
export const KsColorBgInvertedToBg5Base = "#e6e0fa";
export const KsColorBgInvertedToBg6Base = "#ede8fb";
export const KsColorBgInvertedToBg7Base = "#f3f0fc";
export const KsColorBgInvertedToBg8Base = "#f9f7fe";
export const KsColorBgInvertedToBg9Base = "#fdfcfe";
export const KsDepthModal = "1000";
export const KsSpacingXxs = "0.15rem";
export const KsSpacingXxsBase = "0.15rem";
export const KsSpacingXxsBpFactorPhone = "1";
export const KsSpacingXxsBpFactorTablet = "1.25";
export const KsSpacingXxsBpFactorLaptop = "1.75";
export const KsSpacingXxsBpFactorDesktop = "2";
export const KsSpacingXs = "0.35rem";
export const KsSpacingXsBase = "0.35rem";
export const KsSpacingXsBpFactorPhone = "1";
export const KsSpacingXsBpFactorTablet = "1.25";
export const KsSpacingXsBpFactorLaptop = "1.75";
export const KsSpacingXsBpFactorDesktop = "2";
export const KsSpacingS = "0.5rem";
export const KsSpacingSBase = "0.5rem";
export const KsSpacingSBpFactorPhone = "1";
export const KsSpacingSBpFactorTablet = "1.25";
export const KsSpacingSBpFactorLaptop = "1.75";
export const KsSpacingSBpFactorDesktop = "2";
export const KsSpacingM = "1rem";
export const KsSpacingMBase = "1rem";
export const KsSpacingMBpFactorPhone = "1.125";
export const KsSpacingMBpFactorTablet = "1.25";
export const KsSpacingMBpFactorLaptop = "1.75";
export const KsSpacingMBpFactorDesktop = "2";
export const KsSpacingL = "1.5rem";
export const KsSpacingLBase = "1.5rem";
export const KsSpacingLBpFactorPhone = "1.125";
export const KsSpacingLBpFactorTablet = "1.25";
export const KsSpacingLBpFactorLaptop = "1.75";
export const KsSpacingLBpFactorDesktop = "2";
export const KsSpacingXl = "2rem";
export const KsSpacingXlBase = "2rem";
export const KsSpacingXlBpFactorPhone = "1.414";
export const KsSpacingXlBpFactorTablet = "1.25";
export const KsSpacingXlBpFactorLaptop = "1.75";
export const KsSpacingXlBpFactorDesktop = "2";
export const KsSpacingXxl = "2.5rem";
export const KsSpacingXxlBase = "2.5rem";
export const KsSpacingXxlBpFactorPhone = "1.125";
export const KsSpacingXxlBpFactorTablet = "1.25";
export const KsSpacingXxlBpFactorLaptop = "1.75";
export const KsSpacingXxlBpFactorDesktop = "2";
export const KsSpacingStackXxs = "0.15rem";
export const KsSpacingStackXs = "0.35rem";
export const KsSpacingStackS = "0.5rem";
export const KsSpacingStackM = "1rem";
export const KsSpacingStackL = "1.5rem";
export const KsSpacingStackXl = "2rem";
export const KsSpacingStackXxl = "2.5rem";
export const KsSpacingInlineXxs = "0.15rem";
export const KsSpacingInlineXs = "0.35rem";
export const KsSpacingInlineS = "0.5rem";
export const KsSpacingInlineM = "1rem";
export const KsSpacingInlineL = "1.5rem";
export const KsSpacingInlineXl = "2rem";
export const KsSpacingInlineXxl = "2.5rem";
export const KsSpacingInsetXxs = "0.15rem";
export const KsSpacingInsetXs = "0.35rem";
export const KsSpacingInsetS = "0.5rem";
export const KsSpacingInsetM = "1rem";
export const KsSpacingInsetL = "1.5rem";
export const KsSpacingInsetXl = "2rem";
export const KsSpacingInsetXxl = "2.5rem";
export const KsSpacingInsetSquishXs = "0.15rem 0.35rem";
export const KsSpacingInsetSquishS = "0.35rem 0.5rem";
export const KsSpacingInsetSquishM = "0.5rem 1rem";
export const KsSpacingInsetSquishL = "1rem 1.5rem";
export const KsSpacingInsetSquishXl = "1.5rem 2rem";
export const KsSpacingInsetStretchXs = "0.5rem 0.35rem";
export const KsSpacingInsetStretchS = "1rem 0.5rem";
export const KsSpacingInsetStretchM = "1.5rem 1rem";
export const KsSpacingInsetStretchL = "2rem 1.5rem";
export const KsSpacingInsetStretchXl = "2.5rem 2rem";
export const KsTextColorDefaultBase = "#c3c4c9";
export const KsTextColorDefaultInteractiveBase = "#b7a5ff";
export const KsTextColorDefaultInteractiveHoverBase = "rgba(255, 255, 255, 0.87)";
export const KsTextColorDefaultInteractiveActiveBase = "#b7a5ff";
export const KsTextColorDefaultInteractiveVisitedBase = "#b7a5ff";
export const KsTextColorDefaultInvertedBase = "#424355";
export const KsTextColorDefaultInvertedInteractiveBase = "#6642f6";
export const KsTextColorDefaultInvertedInteractiveHoverBase = "#2d1f79";
...
export const KsTextColorInterfaceInvertedInteractiveHoverBase = "#5435d2";
...
export const KsTextColorPrimaryInteractiveBase = "rgba(226, 24, 121, 0.87)";
...
export const KsTextColorPrimaryInteractiveVisitedBase = "rgba(226, 24, 121, 0.87)";
export const KsTextColorPrimaryInvertedBase = "#5435d2";
export const KsTextColorPrimaryInvertedInteractiveBase = "rgba(84, 53, 210, 0.87)";
...
export const KsTextColorPrimaryInvertedInteractiveVisitedBase = "rgba(84, 53, 210, 0.87)";
...
export const KsFontFamilyInterface = "Fredoka, system-ui, -apple-system, BlinkMacSystemFont, 'Avenir Next', 'Avenir', 'Segoe UI', 'Lucida Grande', 'Helvetica Neue', 'Helvetica', 'Fira Sans', 'Roboto', 'Noto', 'Droid Sans', 'Cantarell', 'Oxygen', 'Ubuntu', 'Franklin Gothic Medium', 'Century Gothic', 'Liberation Sans', sans-serif";
...
export const KsFontSizeDisplayBpFactorLaptop = 1.75;
export const KsFontSizeDisplayBpFactorDesktop = 2;
export const KsFontSizeDisplayXxsBase = "0.75rem";
export const KsFontSizeDisplayXsBase = "0.85rem";
export const KsFontSizeDisplaySBase = "1rem";
export const KsFontSizeDisplayMBase = "1.15rem";
export const KsFontSizeDisplayLBase = "1.35rem";
export const KsFontSizeDisplayXlBase = "1.65rem";
export const KsFontSizeDisplayXxlBase = "2.25rem";
export const KsFontSizeCopyBpFactorTablet = 1.125;
export const KsFontSizeCopyXxsBase = "0.5rem";
export const KsFontSizeCopyXsBase = "0.75rem";
export const KsFontSizeCopySBase = "1rem";
export const KsFontSizeCopyMBase = "1.25rem";
export const KsFontSizeCopyLBase = "1.5rem";
export const KsFontSizeCopyXlBase = "1.75rem";
export const KsFontSizeCopyXxlBase = "2rem";
...
export const KsLineHeightDisplayXxs = 1.5;
...
export const KsLineHeightCopyL = 1.45;
