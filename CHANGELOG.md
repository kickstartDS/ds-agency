...
- fix: update component screenshots ([@julrich](https://github.com/julrich))
...
- feat(token): add missing prefix ([@fleven-kds](https://github.com/fleven-kds))
...
# v3.6.42 (Mon Aug 05 2024)

#### ⚠️ Pushed to `main`

- Merge branch 'main' of github.com:kickstartDS/ds-agency ([@fleven-kds](https://github.com/fleven-kds))
- feat(header + footer): disable text decoration ([@fleven-kds](https://github.com/fleven-kds))
...
- feat(cta-paid): increase selector specificity ([@fleven-kds](https://github.com/fleven-kds))
...
- switch to rollup as bundler [#3](https://github.com/kickstartDS/ds-agency/pull/3) ([@lmestel](https://github.com/lmestel))
- upgrade storybook [#1](https://github.com/kickstartDS/ds-agency/pull/1) ([@lmestel](https://github.com/lmestel))

#### ⚠️ Pushed to `main`

- build: set up circleci ([@lmestel](https://github.com/lmestel))
- build: add repeatable controls in storybook ([@lmestel](https://github.com/lmestel))
- Merge branch 'main' of https://github.com/kickstartDS/ds-agency ([@fleven-kds](https://github.com/fleven-kds))
- fea(gallery):develop gallery component ([@fleven-kds](https://github.com/fleven-kds))
- build: make postcss plugins configurable in rollup config ([@lmestel](https://github.com/lmestel))
- feat: rewrite css asset urls ([@lmestel](https://github.com/lmestel))
- feat(FAQ): devlop FAQ component ([@fleven-kds](https://github.com/fleven-kds))
- Merge branch 'main' of github.com:kickstartDS/ds-agency ([@julrich](https://github.com/julrich))
- fix: Section in Storybook ([@julrich](https://github.com/julrich))
- chore: add form and blog modules dependencies ([@julrich](https://github.com/julrich))
- feat(properties): rename "alignment" to "align" ([@fleven-kds](https://github.com/fleven-kds))
- feat(index): replace index references ([@fleven-kds](https://github.com/fleven-kds))
- refactor: fix some ts errors & package exports map ([@lmestel](https://github.com/lmestel))
- fix: remove Demo content page ([@julrich](https://github.com/julrich))
- feature: add Logos and Faq components ([@julrich](https://github.com/julrich))
- feature: add Gallery component ([@julrich](https://github.com/julrich))
- feat(landingpages): develop landingpages ([@fleven-kds](https://github.com/fleven-kds))
- build: add auto config ([@lmestel](https://github.com/lmestel))
- chore: rename package ([@lmestel](https://github.com/lmestel))
- fix: inconsistency in Testimonial story ([@julrich](https://github.com/julrich))
- feature: add stats and testimonials components ([@julrich](https://github.com/julrich))
- feat: update bedrock provider ([@lmestel](https://github.com/lmestel))
- feat(landingpage): add page content ([@fleven-kds](https://github.com/fleven-kds))
- feat: design application ([@fleven-kds](https://github.com/fleven-kds))
- feat(scss): style components ([@fleven-kds](https://github.com/fleven-kds))
- feat(text-color): adjust text-color token ([@fleven-kds](https://github.com/fleven-kds))
- feat(color): add dedicated bg tokens ([@fleven-kds](https://github.com/fleven-kds))
- feat(token): token application ([@fleven-kds](https://github.com/fleven-kds))
- feat(colors): adjust secondary color ([@fleven-kds](https://github.com/fleven-kds))
- feat(color): add secondary color token ([@fleven-kds](https://github.com/fleven-kds))
- feat(style): apply styling ([@fleven-kds](https://github.com/fleven-kds))
- feats(landingpage): add content to landingpage ([@fleven-kds](https://github.com/fleven-kds))
- feat(token): adjust token ([@fleven-kds](https://github.com/fleven-kds))
- Initial commit ([@fleven-kds](https://github.com/fleven-kds))
